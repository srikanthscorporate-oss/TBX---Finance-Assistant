...
// Confirm the images exist and are runnable, not merely that build exited 0.
...
// The API image must contain the prompts, or planning fails at runtime only.
